...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static void ClearSkinWeightOverride(IntPtr _this,int LODIndex);
...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static void SetCapsuleIndirectShadowMinVisibility(IntPtr _this,float NewValue);
...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static void SetCastCapsuleIndirectShadow(IntPtr _this,int bNewValue);
...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static void SetCastCapsuleDirectShadow(IntPtr _this,int bNewValue);
