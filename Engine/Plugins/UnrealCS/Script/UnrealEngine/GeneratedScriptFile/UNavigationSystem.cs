...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static int K2_GetRandomPointInNavigableRadius(IntPtr _this,IntPtr WorldContext,ref FVector Origin,out FVector RandomLocation,float Radius,IntPtr NavData,IntPtr FilterClass);
...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static int K2_GetRandomReachablePointInRadius(IntPtr _this,IntPtr WorldContext,ref FVector Origin,out FVector RandomLocation,float Radius,IntPtr NavData,IntPtr FilterClass);
...
[MethodImplAttribute(MethodImplOptions.InternalCall)]
extern static int K2_ProjectPointToNavigation(IntPtr _this,IntPtr WorldContext,ref FVector Point,out FVector ProjectedLocation,IntPtr NavData,IntPtr FilterClass,ref FVector QueryExtent);
