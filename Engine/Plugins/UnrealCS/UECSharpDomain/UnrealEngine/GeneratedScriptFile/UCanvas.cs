...
public partial class UCanvas:UObject 
{
	...
	static extern FVector2D K2_TextSize(IntPtr _this,IntPtr RenderFont,string RenderText,ref FVector2D Scale);
	...
	/// </summary>
	public  FVector2D TextSize(UFont RenderFont,string RenderText,FVector2D Scale=default(FVector2D))
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern FVector2D K2_StrLen(IntPtr _this,IntPtr RenderFont,string RenderText);
	...
	/// @return                                                      Returns the screen space size of the text.
	/// </summary>
	public  FVector2D StrLen(UFont RenderFont,string RenderText)
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_Deproject(IntPtr _this,ref FVector2D ScreenPosition,out FVector WorldOrigin,out FVector WorldDirection);
	...
	/// </summary>
	public  void Deproject(FVector2D ScreenPosition,out FVector WorldOrigin,out FVector WorldDirection)
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern FVector K2_Project(IntPtr _this,ref FVector WorldLocation);
	...
	/// </summary>
	public  FVector Project(FVector WorldLocation)
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawPolygon(IntPtr _this,IntPtr RenderTexture,ref FVector2D ScreenPosition,ref FVector2D Radius,int NumberOfSides,ref FLinearColor RenderColor);
	...
	/// </summary>
	public  void DrawPolygon(UTexture RenderTexture,FVector2D ScreenPosition,FVector2D Radius=default(FVector2D),int NumberOfSides=3,FLinearColor RenderColor=default(FLinearColor))
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawMaterialTriangle(IntPtr _this,IntPtr RenderMaterial,FCanvasUVTri[] Triangles);
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawTriangle(IntPtr _this,IntPtr RenderTexture,FCanvasUVTri[] Triangles);
	...
	/// @param Triangles                                     Triangles to render.
	/// </summary>
	public  void DrawTriangle(UTexture RenderTexture,FCanvasUVTri[] Triangles)
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawBox(IntPtr _this,ref FVector2D ScreenPosition,ref FVector2D ScreenSize,float Thickness);
	...
	/// </summary>
	public  void DrawBox(FVector2D ScreenPosition,FVector2D ScreenSize,float Thickness=1.000000f)
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawText(IntPtr _this,IntPtr RenderFont,string RenderText,ref FVector2D ScreenPosition,ref FLinearColor RenderColor,float Kerning,ref FLinearColor ShadowColor,ref FVector2D ShadowOffset,int bCentreX,int bCentreY,int bOutlined,ref FLinearColor OutlineColor);
	...
	/// </summary>
	public  void DrawText(UFont RenderFont,string RenderText,FVector2D ScreenPosition,FLinearColor RenderColor=default(FLinearColor),float Kerning=0.000000f,FLinearColor ShadowColor=default(FLinearColor),FVector2D ShadowOffset=default(FVector2D),bool bCentreX=false,bool bCentreY=false,bool bOutlined=false,FLinearColor OutlineColor=default(FLinearColor))
	{
		CheckIsValid();
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawMaterial(IntPtr _this,IntPtr RenderMaterial,ref FVector2D ScreenPosition,ref FVector2D ScreenSize,ref FVector2D CoordinatePosition,ref FVector2D CoordinateSize,float Rotation,ref FVector2D PivotPoint);
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawTexture(IntPtr _this,IntPtr RenderTexture,ref FVector2D ScreenPosition,ref FVector2D ScreenSize,ref FVector2D CoordinatePosition,ref FVector2D CoordinateSize,ref FLinearColor RenderColor,int BlendMode,float Rotation,ref FVector2D PivotPoint);
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void K2_DrawLine(IntPtr _this,ref FVector2D ScreenPositionA,ref FVector2D ScreenPositionB,float Thickness,ref FLinearColor RenderColor);
	...
	/// </summary>
	public  void DrawLine(FVector2D ScreenPositionA,FVector2D ScreenPositionB,float Thickness=1.000000f,FLinearColor RenderColor=default(FLinearColor))
	{
		CheckIsValid();
