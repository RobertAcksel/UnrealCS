...
public partial class UCanvasRenderTarget2D:UTextureRenderTarget2D 
{
	...
	static extern void GetSize(IntPtr _this,out int Width,out int Height);
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern IntPtr CreateCanvasRenderTarget2D(IntPtr _this,IntPtr WorldContextObject,IntPtr CanvasRenderTarget2DClass,int Width,int Height);
	...
	[MethodImplAttribute(MethodImplOptions.InternalCall)]
	static extern void UpdateResource(IntPtr _this);
