...
class UOverlaySlot_
{
	...
	static UClass* _StaticClassForProxy(){return UOverlaySlot::StaticClass();}
	public:
	static void BindFunctions()
	{
		...
		mono_add_internal_call("UnrealEngine.UOverlaySlot::StaticClass",(const void*)_StaticClassForProxy);
