...
namespace UnrealEngine
{
	...
	{
		static void SetIsReadOnly(UMultiLineEditableTextBox* _this,int32 bReadOnly)
		{
		...
		{
			mono_add_internal_call("UnrealEngine.UMultiLineEditableTextBox::SetIsReadOnly",(const void*)SetIsReadOnly);
